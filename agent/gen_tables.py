...
import json, re, sys
sys.path.insert(0, '.')
from openoptions.actions.presets import PRESETS, BUTTON_PRESETS, KEY_PRESETS, WHEEL_PRESETS
from openoptions.config import MX_MASTER_3S, MX_KEYS_S, CONTROL_LABELS, CID_NAMES
codes = []
...
with open('agent/src/tables.gen.h', 'w') as f:
    f.write('// generated from the Python sources (openoptions/actions/presets.py, openoptions/config.py)\n#pragma once\n')
